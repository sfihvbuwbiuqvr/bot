...
**نکته:** وضعیت سوییچ‌ها در جدول `settings` دیتابیس ذخیره می‌شود و بعد از ری‌استارت ربات هم باقی می‌ماند. مقادیر: `yt_off`، `sc_off`، `lyrics_off`، `inline_off`، `cooldown_sec`.
